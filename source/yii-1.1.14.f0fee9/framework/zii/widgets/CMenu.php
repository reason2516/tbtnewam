...
class CMenu extends CWidget
{
	...
	protected function renderMenuRecursive($items)
	{
		...
		foreach($items as $item)
		{
            ...
            if ((isset($item['items']) || (isset($item['online']) && $item['online'] == true)) && !isset($options['class']) ) {
			...
			{
                echo "\n".CHtml::openTag('div', array('class' => 'ul-bg'))."\n";
	...
	protected function renderMenuItem($item)
	{
		if(isset($item['url']))
		{
            ...
            $opion = array();
            if (isset($item['items']) || (isset($item['online']) && $item['online'] == true)) {
                $opion = array('class' => 'menu-item-parent');
            }
            if(isset($item['itemOptions']['class'])){
                $opion = array('class' => 'menu-item-'.$item['itemOptions']['class']); 
            }
            return CHtml::link($label,$item['url'],isset($item['linkOptions']) ? $item['linkOptions'] : $opion).
            CHtml::openTag('div', array('class' => 'line')).CHtml::closeTag('div');
		}
		else
